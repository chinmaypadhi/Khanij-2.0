                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddLeaveRule.aspx">
                                           Add Leave Rule
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewLeaveRule.aspx">
                                           View Leave Rule
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td class="noprint">
                                                            <a href="AddLeaveRule.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewLeaveRule', 'glholiday', 'pllearu', 'tl', 'Leave', 'Leave Rule', ' ');
