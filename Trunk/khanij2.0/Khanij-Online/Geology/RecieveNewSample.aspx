<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecieveNewSample.aspx.cs" Inherits="Geology_RecieveNewSample" %>
                                            ...
                                            <div class="table-responsive" id="viewtable">
                                                <table id="datatable" class="table table-sm table-bordered">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <th  rowspan="2">Element Analysed</th>
                                                   ...
                                                   <th >Name of Camp</th>
                                                    ...
                                                    <tr class="active-row">
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td class="text-warning">Pending for Submission</td>
                                                        <td class="noprint">
                                                         <a class="btn-floating btn-outline-primary btn-sm waves-effect waves-light">Upload</a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('RecieveNewSample', 'glgeology', 'plrecnewsam', 'tl', 'Geology', 'Recieve New Sample', ' ');
