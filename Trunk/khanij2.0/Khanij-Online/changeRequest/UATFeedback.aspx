<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UATFeedback.aspx.cs" Inherits="changeRequest_UATFeedback" %>
...
<uc1:navbar runat="server" ID="navbar" />
                            ...
                            <section class="box form-container">
                                <div class="content-body">
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                       ...
                                       <div class="col-sm-12 offset-lg-2 offset-md-4">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('UATFeedback', 'glchangerequest', 'pluatfee', 'tl', 'Change Request', 'UAT Feedback', ' ');
