<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTailingDamUserProfile.aspx.cs" Inherits="UserInformationSystem_AddTailingDamUserProfile" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewTailingDamUserProfile.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="inputLoginId" class="offset-sm-2 col-form-label">
                                                 <h5 class="m-0">Owner Details</h5></label>
...
<%--<div class="loader-box">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddTailingDamUserProfile', 'glUIS', 'pltailinguserprofil', 'tl', 'User Information System', 'Tailing Dam User Profile', ' ');
