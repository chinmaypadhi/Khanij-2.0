<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMineralForm.aspx.cs" Inherits="Masters_AddMineralForm" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewMineralForm.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddMineralForm', 'glTMng', 'plmineralform', 'tl', 'Masters', ' Mineral Form', '');
