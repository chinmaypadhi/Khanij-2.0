<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDistrict.aspx.cs" Inherits="Masters_AddDistrict" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewDistrict.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<%--<div class="loader-box">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddDistrict', 'glTMng', 'pldistrict', 'tl', 'Masters', 'District', '');
