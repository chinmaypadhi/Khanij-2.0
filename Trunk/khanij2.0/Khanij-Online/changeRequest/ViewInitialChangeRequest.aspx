<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewInitialChangeRequest.aspx.cs" Inherits="changeRequest_ViewInitialChangeRequest" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                   <li class="nav-item">
                                        <a class="nav-link " href="AddInitialChangeRequest.aspx">
                                           Add Initial Change Request
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewInitialChangeRequest.aspx">
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>Pending</td>
                                                            <td class="noprint">
                                                          <a href="AddInitialChangeRequest.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light">Edit</a>
                                                          </td>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewInitialChangeRequest', 'glchangerequest', 'pladdintcr', 'tl', 'Change Request', 'Initial Change Request', ' ');
