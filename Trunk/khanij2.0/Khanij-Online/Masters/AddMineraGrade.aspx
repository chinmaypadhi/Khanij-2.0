<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMineraGrade.aspx.cs" Inherits="Masters_AddMineraGrade" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewMineraGrade.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList ID="DropDownList3" CssClass="form-control searchableselect" runat="server">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                     <asp:DropDownList CssClass="form-control searchableselect" ID="DropDownList2" runat="server">
                                                        <asp:ListItem>Select Mineral</asp:ListItem>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:DropDownList CssClass="form-control searchableselect" ID="dropdownUserType" runat="server">
                                                        <asp:ListItem>Select Mineral Form</asp:ListItem>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddMineraGrade', 'glTMng', 'plmineralgrade', 'tl', 'Masters', 'Mineral Grade', ' ');
