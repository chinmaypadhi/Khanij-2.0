<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FieldReportStatus.aspx.cs" Inherits="Geology_FieldReportStatus" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="FieldReportStatus.aspx">
                                           Add Field Report Status
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewFieldReportStatus.aspx">
                                           View Field Report Status
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                         ...
                                         <div class="col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewFieldReportStatus.aspx" class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('FieldReportStatus', 'glgeology', 'plfierepsta', 'tl', 'Geology', 'Field Program orders', ' ');
