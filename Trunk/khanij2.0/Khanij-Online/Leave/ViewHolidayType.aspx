<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewHolidayType.aspx.cs" Inherits="Leave_ViewHoliday" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddHolidayType.aspx">
                                           Add Holiday Type
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewHolidayType.aspx">
                                           View Holiday Type
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>Optional</td>
                                                            <td class="noprint">
                                                            <a href="AddHolidayType.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewHolidayType', 'glholiday', 'plholtype', 'tl', 'Leave', 'Holiday Type', ' ');
