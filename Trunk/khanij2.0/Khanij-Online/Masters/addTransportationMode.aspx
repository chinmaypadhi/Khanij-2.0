<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addTransportationMode.aspx.cs" Inherits="Masters_addTransportationMode" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewTransportationMode.aspx">
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="dropdownDepart" class="col-sm-4 col-form-label">Transportation Mode<span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add TransportationMode', 'glTMng', 'plmineral', 'tl', 'Masters', 'Transportation Mode', '');
