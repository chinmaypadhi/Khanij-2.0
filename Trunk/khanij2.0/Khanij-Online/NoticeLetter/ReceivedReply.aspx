<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceivedReply.aspx.cs" Inherits="NoticeLetter_ReceivedReply" %>
                                            ...
                                            <div class="table-responsive" id="viewtable">
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td>1</td>
                                                           <td>test</td>
                                                            <td><a href="Received_Reply_Sub.aspx">3</a></td>
                                                            <td>2</td>
                                                            <td>08-01-2021 11:03:19</td>
                                                            <td>
                                                            <a href="SentNoticeDetails.aspx"
