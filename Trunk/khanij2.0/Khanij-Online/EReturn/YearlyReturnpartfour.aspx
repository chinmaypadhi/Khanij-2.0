<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnpartfour.aspx.cs" Inherits="EReturn_YearlyReturnpartfour" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnpartfour.aspx">
                                         Part 4
                                        </a>
                                    </li>
                                    <li class="nav-item">
...
<tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnpartfour', 'glereturn', 'plyearet', 'tl', 'E-Return Non-coal', 'Yearly Return Iron Ore', ' ');
