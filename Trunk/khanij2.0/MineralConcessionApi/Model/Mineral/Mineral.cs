    ...
    public class Mineral : RepositoryBase, IMineral
    {
        ...
        public MessageEF Add(LeaseApplicationModel model)
        {
            ...
            try
            {
                ...
                //Added By Prakash on 02-May-2022
                P.Add("@VCH_PARTICIPATE_BULK_LIST", model.Participant_List);
                P.Add("@USER_ENC_PASSWORD", model.Enc_Password);
                P.Add("@USER_PASSWORD", model.Password);
