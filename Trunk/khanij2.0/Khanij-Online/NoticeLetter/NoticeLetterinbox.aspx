<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoticeLetterinbox.aspx.cs" Inherits="NoticeLetter_NoticeLetterinbox" %>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            <td>1</td>
                                                            <td>Mail by GDM</td>
                                                            <td>18-01-2021 15:31:13</td>
                                                            <td>60</td>
                                                            <td>Reply Sent</td>
                                                            <td><a href="SentNoticeDetails.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light">View</a></td>
                                                         ...
                                                         <tr class="active-row">
                                                            ...
                                                            <td>40</td>
                                                            <td><a href="SentNoticeDetails.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light">View</a></td>
                                                            <td><a href="Notice_Replay.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light">Reply</a></td>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('NoticeLetterinbox', 'glnoticeletter', 'plnotinbox', 'tl', 'Notice Letter', 'Notice/Letter Inbox', ' ');
