<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsentToOperateDetails.aspx.cs" Inherits="LesseeProfile_ConsentToOperateDetails" %>
...
<uc1:navbar runat="server" ID="navbar" />
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ConsentToOperateDetails', 'glRoleRes', 'pllesseprof', 'tl', 'Roles and Responsibity', 'Lessee Profile', ' ');
        });
    </script>
