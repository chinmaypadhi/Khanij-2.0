<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLeaveRule.aspx.cs" Inherits="Leave_AddLeaveRule" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddLeaveRule.aspx">
                                           Add Leave Rule
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewLeaveRule.aspx">
                                           View Leave Rule
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewLeaveRule.aspx"  class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddLeaveRule', 'glholiday', 'pllearu', 'tl', 'Leave', 'Leave Rule', ' ');
