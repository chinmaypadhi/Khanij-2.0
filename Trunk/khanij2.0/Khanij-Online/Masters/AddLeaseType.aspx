<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLeaseType.aspx.cs" Inherits="Masters_AddLeaseType" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewLeaseType.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddLeaseType', 'glTMng', 'plleasetype', 'tl', 'Masters', 'Lease Type', ' ');
