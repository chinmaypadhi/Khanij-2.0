<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAuthorities.aspx.cs" Inherits="Leave_ViewAuthorities" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddAuthorities.aspx">
                                           Add Authorities
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewAuthorities.aspx">
                                           View Authorities
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Officee</th>
                                                            <th>Section</th>
                                                            <th>Verify Designation</th>
                                                            <th>Forward Department</th>
                                                            <th>Forward Designation</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>Dummy Text</td>
                                                            <td class="noprint">
                                                            <a href="AddAuthorities.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewAuthorities', 'glholiday', 'plauth', 'tl', 'Leave', 'Authorities', ' ');
