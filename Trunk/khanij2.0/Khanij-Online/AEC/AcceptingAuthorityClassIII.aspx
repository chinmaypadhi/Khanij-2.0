<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceptingAuthorityClassIII.aspx.cs" Inherits="AEC_AcceptingAuthorityClassIII" %>
...
<uc1:navbar runat="server" ID="navbar" />
                                ...
                                <div class="content-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                         ...
                                         <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Reviewing  Authority Remarks about work details</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
                                         ...
                                         <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Reviewing  Authority Grade</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AcceptingAuthorityClassIII', 'glaec', 'placcauc', 'tl', 'AEC', 'Accepting Authority Class III', ' ');
