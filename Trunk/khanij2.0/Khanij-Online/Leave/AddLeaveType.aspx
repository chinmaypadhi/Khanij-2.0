<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLeaveType.aspx.cs" Inherits="Leave_AddLeaveType" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddLeaveType.aspx">
                                           Add Leave Type
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewLeaveType.aspx">
                                           View Leave Type
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                         ...
                                         <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewLeaveType.aspx" class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddLeaveType', 'glholiday', 'plleatyp', 'tl', 'Leave', 'Leave Type', ' ');
