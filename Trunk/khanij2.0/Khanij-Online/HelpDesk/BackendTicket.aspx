<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BackendTicket.aspx.cs" Inherits="HelpDesk_BackendTicket" %>
                            ...
                            <section class="box form-container">
                                <div class="content-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-4 col-form-label font-weight-bolder">Problem Type</label>
                                                <div class="col-sm-7">
                                                   <asp:DropDownList ID="DropDownList2" runat="server" class="form-control" >
                                                  <asp:ListItem value="0" Text="--Select--"></asp:ListItem>
                                                   <asp:ListItem value="0" Text="User Side" ></asp:ListItem>
                                                   <asp:ListItem value="0" Text="Application Side" ></asp:ListItem>
                                                  </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dropdownUserType" class="col-sm-4 col-form-label font-weight-bolder">Forwarded To</label>
                                                <div class="col-sm-7">
                                                    <asp:DropDownList ID="DropDownList5" runat="server" class="form-control" >
                                                  <asp:ListItem value="0" Text="--Select--"></asp:ListItem>
                                                   <asp:ListItem value="0" Text="OSU" ></asp:ListItem>
                                                   <asp:ListItem value="0" Text="DPU" ></asp:ListItem>
                                                  </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dropdownDepart" class="col-sm-4 col-form-label font-weight-bolder">Select User</label>
                                                <div class="col-sm-7">
                                                    <asp:DropDownList ID="DropDownList6" runat="server" class="form-control" >
                                                  <asp:ListItem value="0" Text="--Select--"></asp:ListItem>
                                                   <asp:ListItem value="0" Text="Rajesh Kumar" ></asp:ListItem>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dropdownDesign" class="col-sm-4 col-form-label font-weight-bolder">Remark </label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6 offset-sm-2">
                                               ...
                                               <asp:Button ID="Button1" class="btn btn-primary btn-md ml-0" runat="server" 
                                                    Text="Submit" onclick="Button1_Click1"></asp:Button>
