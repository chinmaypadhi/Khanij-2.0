<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewWork.aspx.cs" Inherits="Geology_ViewWork" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddWork.aspx">
                                           Add Work
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewWork.aspx">
                                           View Work
                                        </a>
                                    </li>
                                </ul>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewWork', 'glgeology', 'plmonprorep', 'tl', 'Geology', 'Monthly Progress Reports', ' ');
