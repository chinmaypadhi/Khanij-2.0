<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLicenseType.aspx.cs" Inherits="Masters_AddLicenseType" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewLicenseType.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<%--<div class="loader-box">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddLicenseType', 'glTMng', 'pllicensetype', 'tl', 'Masters', '  License Type', '');
