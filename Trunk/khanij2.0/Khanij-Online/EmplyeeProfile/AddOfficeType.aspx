<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOfficeType.aspx.cs" Inherits="EmplyeeProfile_OfficeType" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddOfficeType.aspx">
                                           Add Office Type
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " href="ViewOfficeType.aspx">
                                          View  Office Type
                                        </a>
                                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-lg-2 col-md-4 col-sm-12 col-form-label font-weight-bolder">Office Type Name<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-6 offset-lg-2 offset-md-4">
                                                <a href="ViewOfficeType.aspx" class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddOfficeType', 'glempprofile', 'plofficetype', 'tl', 'Employee Profile', 'Office Type', ' ');
