<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradingReviewingAuthority.aspx.cs" Inherits="AEC_GradingReviewingAuthority" %>
...
<uc1:navbar runat="server" ID="navbar" />
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent blandit magna vitae mattis hendre</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                ...
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>Praesent blandit magna vitae</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('GradingReviewingAuthority', 'glaec', 'plgreau', 'tl', 'AEC', 'Grading Reviewing Authority', ' ');
