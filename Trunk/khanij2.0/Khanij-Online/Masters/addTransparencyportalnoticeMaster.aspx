<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addTransparencyportalnoticeMaster.aspx.cs" Inherits="Masters_addTransparencyportalnoticeMaster" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewTransparencyportalnoticeMaster.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                   <uc1:util runat="server" ID="util1" />
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <label for="inputLoginId" class="col-sm-4 col-form-label">Notice Text <span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
                                          
                                            <input type="text" class="form-control"  name="NoticeText" id="NoticeText"/>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Transparency portal notice', 'glTMng', 'plmineral', 'tl', 'Masters', 'Transparency portal notice', '');
