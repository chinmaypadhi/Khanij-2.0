<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Viewstate.aspx.cs" Inherits="Masters_Viewstate" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="Addstate.aspx">
                                            Add New State
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td class="noprint"><a href="Addstate.aspx"
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Viewstate', 'glTMng', 'plstate', 'tl', 'Masters', 'State', '');
