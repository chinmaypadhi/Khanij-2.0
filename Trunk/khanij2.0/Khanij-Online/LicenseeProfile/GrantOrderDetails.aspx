<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrantOrderDetails.aspx.cs" Inherits="LicenseeProfile_GrantOrderDetails" %>
...
<uc1:navbar runat="server" ID="navbar" />
                            ...
                            <section class="box form-container">
                                ...
                                <h5 class="text-brown font-weight-bold mt-0"> Grant Order Details</h5>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                 <label for="inputLoginId" class="col-form-label font-weight-bolder">Grant Order Copy<span class="text-danger">*</span></label>
                                                 <div class="custom-file">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('GrantOrderDetails', 'glRoleRes', 'pllicenprof', 'tl', 'Roles and Responsibity', 'Licensee Profile', ' ');
        });
    </script>
