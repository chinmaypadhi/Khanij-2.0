<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vehicleownerRegistraion.aspx.cs" Inherits="vehicleownerRegistraion" %>
        ...
        <div class="pt-lg-5 pt-md-4 pt-3">
            <nav aria-label="breadcrumb mb-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white" aria-current="page">Vehicle Owner Registration</li>
                    </ol>
             </nav>
        </div>
    </div>
...
<form id="form1" runat="server">
    <uc1:loginheader runat="server" ID="loginheader" />
            <div class="main-content py-3 login-content">
                ...
                <h4 class="text-dark font-weight-bold my-4 text-uppercase">Vehicle Owner Registration </h4>
                <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-5 col-form-label font-weight-bolder">Owner Type<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <div class="py-2">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Name of Company/Firm/Association<span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" >
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">GST No.<span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Name Of Applicant <span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" >
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-5 col-form-label font-weight-bolder">State<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Mobile Number<span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="dropdownDepart" class="col-sm-5 col-form-label font-weight-bolder">PAN Card Number<span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control">                                                    
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-5 col-form-label font-weight-bolder">Pin Code<span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="form-group row">
                    <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Complete Address<span class="text-danger">*</span></label>
                    <div class="col-sm-7">
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
         $(document).ready(function () {
             $('.vehicleownerreg').addClass('active');
         }) 
    </script> 
</body>
</html>
