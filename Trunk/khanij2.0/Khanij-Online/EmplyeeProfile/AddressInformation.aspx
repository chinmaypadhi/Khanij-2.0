<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddressInformation.aspx.cs" Inherits="EmplyeeProfile_Address_Information" %>
...
<uc1:navbar runat="server" ID="navbar" />
                                ...
                                <div class="content-body">
                                    ...
                                    <div class="form-group row">
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                               <label class="col-form-label font-weight-bolder">present Address</label>
                                            ...
                                            <div class="col-lg-3 col-md-12 col-sm-12">
                                             ...
                                             <div class="col-lg-3 col-md-12 col-sm-12">
                                                <label class="col-form-label font-weight-bolder">Email Id</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                    <h5 class="text-brown font-weight-bold">Permanent  Address</h5>
                                    </div>
                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group row">
                                            <div class="col-lg-3 col-md-12 col-sm-12">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddressInformation', 'glempprofile', 'pladdinf', 'tl', 'Employee Profile', 'Address Information', ' ');
