<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnCopperPart5.aspx.cs" Inherits="EReturn_YearlyReturnCopperPart5" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnCopperPart5.aspx">
                                         Part 5
                                        </a>
                                    </li>
                                    <li class="nav-item">
...
<ul class="nav nav-tabs progressbar border-0" id="myTab" role="tablist">
                                ...
                                <div class="tab-content" id="myTabContent">
                                  ...
                                  <div class="row">
                                   <h5 class="text-brown font-weight-bold w-100 pl-3">Drilling</h5>
                                    <div class="col-xl-6">
                                  ...
                                  <div class="row">
                                        <h5 class="text-brown font-weight-bold  w-100 pl-3">Pitting</h5>
                                        <div class="col-xl-6">
                                        <div class="bg-light p-2 form-group border">
                                  ...
                                  <div class="row">
                                        <h5 class="text-brown font-weight-bold w-100 pl-3">Trenching</h5>
                                        <div class="col-xl-4">
                                        <div class="bg-light p-2 form-group border">
...
<td><input class=" form-control" type="number"></td>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnCopperPart5', 'glereturn', 'plyearetcop', 'tl', 'E-Return Non-coal', 'Yearly Return Copper', ' ');
