...
namespace IntegrationEF
{
    ...
    public class LeaseApplicationModel
    {
        ...
        public string KhasraFileName { get; set; }
        ...
        //Added on 02052022
        public string TopoSheetFileName { get; set; }
        public string TopoSheetFilePath { get; set; }
       ...
       public IEnumerable<SelectListItem> LOI_StatutoryDocuments { get; set; }
        ...
        //by SAROJ
        public string DGMdocument_List { get; set; }
        ...
        public string PreferredBidder_Letter_File_Path { get; set; }
        public string PreferredBidder_Letter_File_Name { get; set; }
    ...
    public class PreferredBidder
    {
        ...
        public string LocationDistState { get; set; }
        public string HeighestBidderName { get; set; }
        public string AppliedOn { get; set; }
        public int Status_Id { get; set; }
        public string StatusName { get; set; }
        public string UserName { get; set; }
        public string PendingDayCount { get; set; }
        public int ActionId { get; set; }
