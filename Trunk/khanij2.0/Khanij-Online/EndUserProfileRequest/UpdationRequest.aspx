<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdationRequest.aspx.cs" Inherits="EndUserProfileRequest_UpdationRequest" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item mr-md-1">
                                        <a class="nav-link active" href="UpdationRequest.aspx">
                                           Updation Request
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>
																KHATA-NO- 614/2381
                                                                DANI SAHI,
                                                                BOUDH-762014 - [Trader Outside Chhattisgarh]
															</td>
                                                            <td>                                                                
                                                              Boudh																
                                                            </td>
                                                            ...
                                                            <td class="noprint">
                                                                <a href="UpdationRequestView.aspx" class="btn-floating btn-outline-primary btn-sm"
