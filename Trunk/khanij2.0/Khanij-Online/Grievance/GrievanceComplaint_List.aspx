<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrievanceComplaint_List.aspx.cs" Inherits="Grievance_GrievanceComplaint_List" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="GrievanceComplaint_List.aspx">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>
                                                             ...
                                                             <td>
																<p class="m-0">	28/12/2018</p>
															</td>
                                                             <td>
																<p class="m-0">	Resolved</p>
															</td>
                                                             <td class="noprint">
																<p class="m-0">	
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewPaymentHead', 'glTMng', 'plpaymenthead', 'tl', 'Grievance', 'Grievance Complaint List', ' ');
