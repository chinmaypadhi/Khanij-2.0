<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnvironmentClearanceDetails.aspx.cs" Inherits="LicenseeProfile_EnvironmentClearanceDetails" %>
...
<uc1:navbar runat="server" ID="navbar" />
                            ...
                            <section class="box form-container">
                                ...
                                <h5 class="text-brown font-weight-bold mt-0"> Environment Clearnance Details</h5>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                <label class="col-form-label font-weight-bolder">Environmental Clearance Valid From<span class="text-danger">*</span></label>
                                               <div class="input-group">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                <label class="col-form-label font-weight-bolder">Approved Quantity <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control">
                                            </div>
                                          
                                       
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                <label class="col-form-label font-weight-bolder">Environmental Clearance Letter<span class="text-danger">*</span></label>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('EnvironmentClearanceDetails', 'glRoleRes', 'pllicenprof', 'tl', 'Roles and Responsibity', 'Licensee Profile', ' ');
        });
    </script>
