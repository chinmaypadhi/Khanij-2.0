<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddRiderLeave.aspx.cs" Inherits="Leave_AddRiderLeave" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddRiderLeave.aspx">
                                           Add Rider Leave
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewRiderLeave.aspx">
                                           View Rider Leave
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewRiderLeave.aspx"  class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddRiderLeave', 'glholiday', 'plridleav', 'tl', 'Leave', 'Rider leave', ' ');
