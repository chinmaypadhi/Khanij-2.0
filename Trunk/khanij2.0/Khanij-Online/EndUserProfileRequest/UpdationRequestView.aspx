<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdationRequestView.aspx.cs" Inherits="EndUserProfileRequest_UpdationRequestView" %>
                                ...
                                <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>Trader Outside Chhattisgarh</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="dropdownUserType" class="col-sm-5 col-form-label font-weight-bolder">User name</label>
                                                <div class="col-sm-7">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>xxxx</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Individual/Proprietor</label>                                                   
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Aadhaar Card Number</label>
                                                <div class="col-sm-7">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>923516511303</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="inputMail" class="col-sm-5 col-form-label font-weight-bolder">Upload Aadhaar Card</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>BZYPD4298K</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-3">
                                         ...
                                         <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="inputMail" class="col-sm-1 col-form-label font-weight-bolder">Use Remark</label>
                                                <div class="col-sm-11">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>KHATA-NO- 614/2381 DANI SAHI, BOUDH-762014</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
