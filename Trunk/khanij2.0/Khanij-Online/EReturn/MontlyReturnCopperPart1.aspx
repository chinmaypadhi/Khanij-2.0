<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MontlyReturnCopperPart1.aspx.cs" Inherits="EReturn_MontlyReturnCopperPart1" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="MontlyReturnCopperPart1.aspx">
                                         Part 1
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="MontlyReturnCopperPart2.aspx">
                                         Part 2
                                        </a>
                                    </li>
                                </ul>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('MontlyReturnCopperPart1', 'glereturn', 'plmonretcop', 'tl', 'E-Return Non-coal', 'Monthly Return Copper', ' ');
        });
    </script>
