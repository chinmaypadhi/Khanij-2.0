<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addMineralUnit.aspx.cs" Inherits="Masters_addMineralUnit" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewMineralUnit.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Mineral Unit', 'glTMng', 'plmineral', 'tl', 'Masters', 'Mineral Unit', '');
