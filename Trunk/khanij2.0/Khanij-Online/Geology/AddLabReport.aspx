<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLabReport.aspx.cs" Inherits="Geology_AddLabReport" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddLabReport.aspx">
                                           Add Lab Report
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewLabReport.aspx">
                                           View Lab Report
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <section class="box form-container">
                                <div class="content-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Name of Camp<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                         ...
                                         <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Type of Samples<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">No. of Samples<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Type of Study/Analysis<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                   <select class="form-control form-control-sm searchableselect">
                                                          <option>select</option>
                                                      </select> 
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Date of Submission</label>
                                                <div class="col-sm-7">
                                                   <div class="input-group">
                                                      <input type="text" class="form-control datepicker" id="inputDate5" disabled>
                                                      <div class="input-group-prepend">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Field Officer</label>
                                                <div class="col-sm-7">
                                                   <input type="text" class="form-control" disabled>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label  class="col-sm-4 col-form-label font-weight-bolder">Field Officer Designation</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                         ...
                                         <div class="col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-6 offset-lg-2">
                                                <a href="ViewLabReport.aspx" class="btn btn-primary btn-md ml-0" 
                                                >Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddLabReport', 'glgeology', 'pllabrep', 'tl', 'Geology', 'Lab Report', ' ');
