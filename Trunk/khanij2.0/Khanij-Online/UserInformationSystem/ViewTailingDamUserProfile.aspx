<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewTailingDamUserProfile.aspx.cs" Inherits="UserInformationSystem_ViewTailingDamUserProfile" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="AddTailingDamUserProfile.aspx">
                                            Add 
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                    <asp:DropDownList ID="DropDownList1" CssClass="form-control searchableselect" runat="server">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                     <asp:DropDownList ID="DropDownList2" CssClass="form-control searchableselect" runat="server">
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewTailingDamUserProfile', 'glUIS', 'pltailinguserprofil', 'tl', 'User Information System', 'Tailing Dam User Profile', ' ');
