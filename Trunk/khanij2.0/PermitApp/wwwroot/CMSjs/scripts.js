...
$('.nav-toggle-btn').on('click', function () {
    ...
    $('.breadcrumb-nav').toggleClass('full');
})
...
$(document).ready(function() {
    ...
    checkStatus();
     ...
     $('.searchform').hide();
    $("<div class='text-center '><a href='#' class='btn btn-sm shadow-sm searchbtn rounded-0 waves-effect waves-light'><i class='icon-filter-solid'></i><span >More Filter</span></a></div>").insertAfter(".searchform");

	$('.searchbtn').click(function(){
		$('.searchform').slideToggle();
        $('.searchbtn i').toggleClass('icon-times-solid icon-filter-solid ');
...
// table-responsive class adding in the parent div because of scrolling issue
    $(function () {
    $("#table-exports , #table-landscape").parent().addClass('table-responsive');
...
$(window).scroll(function () {
    ...
    if (scroll > 0) {
        $(".page-topbar , .breadcrumb-nav").addClass("active");
    } else {
        $(".page-topbar , .breadcrumb-nav").removeClass("active");
    }
});