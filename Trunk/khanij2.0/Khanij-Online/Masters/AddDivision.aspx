<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDivision.aspx.cs" Inherits="Masters_AddDivision" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewDivision.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddDivision', 'glTMng', 'plDivision', 'tl', 'Masters', 'Division', '');
