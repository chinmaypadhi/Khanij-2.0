<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addPolicyMaster.aspx.cs" Inherits="Masters_addPolicyMaster" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewPolicyMaster.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select  id="" name="Plice" class="form-control">
