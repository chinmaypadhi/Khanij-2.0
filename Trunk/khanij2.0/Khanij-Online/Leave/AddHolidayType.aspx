<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddHolidayType.aspx.cs" Inherits="Leave_AddHoliday" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="AddHolidayType.aspx">
                                           Add Holiday Type
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewHolidayType.aspx">
                                           View Holiday Type
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="py-2">
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                        ...
                                                        <label class="custom-control-label" for="radiop">Optional</label>
                                                      </div>
                                                      <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="custom-control-input" id="radiopro" name="radio-iRequirement" value="2">
                                                        <label class="custom-control-label" for="radiopro">Mandatory</label>
                                                      </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewHolidayType.aspx" class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddHolidayType', 'glholiday', 'plholtype', 'tl', 'Leave', 'Holiday Type', ' ');
