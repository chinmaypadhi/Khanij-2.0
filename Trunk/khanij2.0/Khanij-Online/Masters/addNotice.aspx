<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addNotice.aspx.cs" Inherits="Masters_addNotice" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewNotice.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="inputLoginId" class="col-sm-4 col-form-label">Notice<span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Notice', 'glTMng', 'plmineral', 'tl', 'Masters', 'Add Notice', '');
