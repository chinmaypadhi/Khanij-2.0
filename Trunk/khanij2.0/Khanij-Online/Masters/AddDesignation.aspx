<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDesignation.aspx.cs" Inherits="Masters_AddDesignation" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewDesignation.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddDesignation', 'glTMng', 'pldesignation', 'tl', 'Master', 'Designation', ' ');
