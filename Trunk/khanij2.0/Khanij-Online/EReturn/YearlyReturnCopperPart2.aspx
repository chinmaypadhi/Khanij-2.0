<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnCopperPart2.aspx.cs" Inherits="EReturn_YearlyReturnCopperPart2" %>
...
<uc1:navbar runat="server" ID="navbar" />
                            ...
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnCopperPart2.aspx">
                                         Part 2
                                        </a>
                                    </li>
                                    <li class="nav-item">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnCopperPart2', 'glereturn', 'plyearetcop', 'tl', 'E-Return Non-coal', 'Yearly Return Copper', ' ');
        });
    </script>
