...
namespace MasterApi.Controllers
{
    ...
    public class WorkFlowActivityController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<List<WorkFlowDropDown>> BindWorkFlowDDLAuthority(WorkFlowDropDown objWorkFlow)
        {
            return await _objIActivity.BindDropDownSetAuthority(objWorkFlow);
        }
