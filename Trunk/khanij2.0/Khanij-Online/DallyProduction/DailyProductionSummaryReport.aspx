<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyProductionSummaryReport.aspx.cs" Inherits="DallyProduction_DailyProductionSummaryReport" %>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('DailyProductionSummaryReport', 'glTMng', 'plmineral', 'tl', 'Masters', 'Daily Production Summary Report', '');
