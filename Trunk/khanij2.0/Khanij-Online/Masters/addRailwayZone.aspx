<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addRailwayZone.aspx.cs" Inherits="Masters_addRailwayZone" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="/Master/RailwayZone/Add">
                                Add Railway Zone
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="ViewRailwayZone.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                ...
                <section class="box form-container">
                    <div class="content-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-4 col-form-label">Railway Zone <span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
                                            <input type="text" id="txtRailwayZoneName" name="RailwayZoneName" Class="form-control" />
                                            <input type="hidden" id="hdnRailwayZoneID" name="RailwayZoneID"  />
                                        </div>
                                    </div>
                                </div>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Railway Zone', 'glTMng', 'plmineral', 'tl', 'Masters', 'Railway Zone', '');
