<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MontlyReturnformM.aspx.cs" Inherits="EReturnLicensee_MontlyReturnformM" %>
...
<uc1:navbar runat="server" ID="navbar" />
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <section class="box form-container">
                                ...
                                <h6 class="font-weight-bold">For the financial year <small>(1st April, 2020 to 31st March, 2021) </small></h6>
                                <p class="font-weight-normal mb-0">Form M [See rule 45(6)(b)]</p>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('MontlyReturnformM', 'glereturnlicensee', 'plerlieyearly', 'tl', 'E-Return Licensee', 'Yearly Return', ' ');
