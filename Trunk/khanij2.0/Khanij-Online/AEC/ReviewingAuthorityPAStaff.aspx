<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewingAuthorityPAStaff.aspx.cs" Inherits="AEC_ReviewingAuthorityPAStaff" %>
...
<uc1:navbar runat="server" ID="navbar" />
                                ...
                                <div class="content-body">
                                   ...
                                   <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Reporting authority name</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                    <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Stenography speed</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder"> Ability to writing remarks</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Maintain  relation to visitor  </label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                   <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-2 row">
                                                <label  class="col-lg-5 col-md-6 col-sm-12 col-form-label font-weight-bolder">Ability to keep information confidential</label>
                                                <div class="col-lg-7 col-md-6 col-sm-12">
                                                  <label class="form-control-plaintext"><span class="colon">:</span>Dummy Text</label>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ReviewingAuthorityPAStaff', 'glaec', 'plrapss', 'tl', 'AEC', 'Reviewing Authority PA Staff', ' ');
