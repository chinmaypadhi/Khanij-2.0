<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnCopperPart6.aspx.cs" Inherits="EReturn_YearlyReturnCopperPart6" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnCopperPart6.aspx">
                                         Part 6
                                        </a>
                                    </li>
                                    <li class="nav-item">
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnCopperPart6', 'glereturn', 'plyearetcop', 'tl', 'E-Return Non-coal', 'Yearly Return Copper', ' ');
