<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewHoliday.aspx.cs" Inherits="Leave_ViewHoliday" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddHoliday.aspx">
                                           Add Holiday
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewHoliday.aspx">
                                           View Holiday
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>08-02-2021</td>
                                                            <td class="noprint">
                                                            <a href="AddHoliday.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewHoliday', 'glholiday', 'plholiday', 'tl', 'Leave', 'Holiday', ' ');
