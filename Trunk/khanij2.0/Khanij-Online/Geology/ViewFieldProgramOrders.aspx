<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewFieldProgramOrders.aspx.cs" Inherits="Geology_ViewFieldProgramOrders" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="FieldProgramOrders.aspx">
                                           Add Field Program Orders
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewFieldProgramOrders.aspx">
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <a href="javascript:void(0);" class="btn-floating btn-outline-danger btn-sm waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Delete" "=""><i class="far fa-trash-alt"></i></a>
                                                        ...
                                                        <tr class="active-row">
                                                            <td>6528/2018-19</td>
                                                            <td>6528/Geo-1/F.No. 21/Field Pro/18-19/27-08-2018</td>
                                                            <td>01/02/2021</td>
                                                            <td>2019-2020</td>
                                                            <td><a href="#"><i class="far fa-file-pdf h3"></i></a></td>
                                                            <td class="text-success">Active</td>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewFieldProgramOrders', 'glgeology', 'plfieprord', 'tl', 'Geology', 'Field Program orders', ' ');
