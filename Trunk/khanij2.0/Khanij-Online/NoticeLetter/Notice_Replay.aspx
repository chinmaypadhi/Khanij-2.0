<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Notice_Replay.aspx.cs" Inherits="NoticeLetter_Notice_Replay" %>
                                       ...
                                       <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                               ...
                                               <textarea name="textAddress" rows="5" cols="20" id="textAddress" class="form-control"></textarea>
                                            </div>
                                       </div>

                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                                <label  class="col-form-label font-weight-bolder">Upload Document</label>
