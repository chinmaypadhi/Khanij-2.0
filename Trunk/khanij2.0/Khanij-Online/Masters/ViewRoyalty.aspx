<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewRoyalty.aspx.cs" Inherits="Masters_ViewRoyalty" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="addRoyalty.aspx" >
                                Add Raoyalty
                            </a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <table id="datatable" class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>7.5</td>
                                                        <td>99.04</td>
                                                        <td>01/08/2020 00:00:00	</td>
                                                        <td>Approved</td>
                                                        <td>05/12/2020 14:46:41	</td>
                                                        <td>09/12/2020 10:59:24	</td>
                                                        <td class="noprint">
                                                            <a href="#"
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewRoyalty', 'glTMng', 'pldistrict', 'tl', 'Masters', 'Royalty', '');
