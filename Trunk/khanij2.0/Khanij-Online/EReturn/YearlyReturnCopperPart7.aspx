<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnCopperPart7.aspx.cs" Inherits="EReturn_YearlyReturnCopperPart7" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnCopperPart7.aspx">
                                         Part 7
                                        </a>
                                    </li>
                                </ul>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnCopperPart7', 'glereturn', 'plyearetcop', 'tl', 'E-Return Non-coal', 'Yearly Return Copper', ' ');
        });
    </script>
