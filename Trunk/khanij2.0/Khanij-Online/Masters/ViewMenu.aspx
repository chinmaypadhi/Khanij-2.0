<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewMenu.aspx.cs" Inherits="Masters_ViewMenu" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="addMenu.aspx" >
                                Add
                            </a>
                        </li>
                        <li class="nav-item">
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewMenu', 'glTMng', 'pldistrict', 'tl', 'Masters', 'Menu', '');
