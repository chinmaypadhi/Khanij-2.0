<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IBMDetails.aspx.cs" Inherits="LicenseeProfile_IBMDetails" %>
...
<uc1:navbar runat="server" ID="navbar" />
                                ...
                                <h5 class="text-brown font-weight-bold mt-0"> IBM Details</h5>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                                <label class="col-form-label pt-0 font-weight-bolder">IBM/DGM Registration Form - M<span class="text-danger">*</span></label>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('IBMDetails', 'glRoleRes', 'pllicenprof', 'tl', 'Roles and Responsibity', 'Licensee Profile', ' ');
        });
    </script>
