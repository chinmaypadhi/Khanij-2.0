<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addRoute.aspx.cs" Inherits="Masters_addRoute" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewRoute.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <label for="inputLoginId" class="col-sm-4 col-form-label">Route <span class="text-danger">*</span></label>
                                        <div class="col-sm-7">
