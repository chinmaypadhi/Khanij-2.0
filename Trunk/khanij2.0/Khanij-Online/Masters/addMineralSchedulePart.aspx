<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addMineralSchedulePart.aspx.cs" Inherits="Masters_addMineralSchedulePart" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewMineralSchedulePart.aspx" >
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" id="txtMineralSchedulePartName" name="MineralSchedulePartName" value="" class ="form-control" />
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Mineral Schdule Part', 'glTMng', 'plmineral', 'tl', 'Masters', 'Mineral Schdule part', '');
