<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMineralCategory.aspx.cs" Inherits="Masters_AddMineralCategory" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewMineralCategory.aspx">
                                View
                            </a>
                        </li>
                    </ul>
