<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MontlyReturnCopperPart2.aspx.cs" Inherits="EReturn_MontlyReturnCopperPart2" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link " href="MontlyReturnCopperPart1.aspx">
                                         Part 1
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="MontlyReturnCopperPart2.aspx">
                                         Part 2
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <section class="box form-container">
                                ...
                                <p class="font-weight-normal mb-0">To be used for minerals other than Copper, Gold, Lead, Pyrites, Tin, Tungsten, Zinc and precious and semi-precious stones
                                 ...
                                 <h6 class="font-weight-bold">Production, Despatches and stocks , To be submitted separately for each mineral , Unit of quantity in tonnes: indicate unit of quantity if not in tonnes<small> (Part – II)</small></h6>
                                </div>
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('MontlyReturnCopperPart2', 'glereturn', 'plmonretcop', 'tl', 'E-Return Non-coal', 'Monthly Return Copper', ' ');
