<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewMineralCategory.aspx.cs" Inherits="Masters_ViewMineralCategory" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="AddMineralCategory.aspx">
                                Add 
                            </a>
                        </li>
                        <li class="nav-item">
