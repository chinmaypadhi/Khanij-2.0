<%@ Page Language="C#" AutoEventWireup="true" CodeFile="close.aspx.cs" Inherits="Epermitlicensee_close" %>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="main-tab">
                                                            <ul class="nav nav-tabs">
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="generated.aspx">
                                                                     Generated
                                                                    </a>
                                                                </li>
                                                                 <li class="nav-item">
                                                                    <a class="nav-link active" href="close.aspx">
                                                                    Closed
                                                                    </a>
                                                                </li>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-right">Pending Quantity (MT)</th>
                                                    ...
                                                    <tbody>
                                                        <tr >
                                                            ...
                                                            <td>Coal</td>
                                                            <td>Non Coking-Reject</td>
                                                            <td>Not Applicable</td>
                                                           
                                                            <td class="text-right">60.15</td>
                                                             <td class="text-right">5.00</td>
                                                            <td class="text-center"><a href="javascript:void(0);" class="btn-floating btn-outline-danger btn-sm waves-effect waves-light">Close E-permit</a></td>
                                                        </tr>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('close', 'glepermitlicensee', 'applied', 'tl', 'e-permit', 'Apply e-permit', ' ');
