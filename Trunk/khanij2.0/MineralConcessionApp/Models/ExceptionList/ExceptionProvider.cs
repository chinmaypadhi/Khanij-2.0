...
namespace MineralConcessionApp.Model.ExceptionList
{
    public class ExceptionProvider:IExceptionProvider
    {
        ...
        public string ErrorList(LogEntry objLogEntry)
        {
            try
            {
              string   s = JsonConvert.DeserializeObject<string>(_objIHttpWebClients.PostRequest("ExceptionData/AddException", ""));
                return s;
            }
        ...
        //    try
        //    {
        //        objlogin = JsonConvert.DeserializeObject<UserLoginSession>(_objIHttpWebClients.PostRequest("ExceptionData/getuserDetail", JsonConvert.SerializeObject(objLogEntry)));
        //        return objlogin;
        //    }
        //    catch (System.Exception ex)
        //    {
