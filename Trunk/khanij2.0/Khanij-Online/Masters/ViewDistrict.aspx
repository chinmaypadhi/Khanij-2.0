<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDistrict.aspx.cs" Inherits="Masters_ViewDistrict" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="AddDistrict.aspx">
                                            Add New  District
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td class="noprint"><a href="AddDistrict.aspx"
