<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAppraisalforDriver.aspx.cs" Inherits="AEC_ViewAppraisalforDriver" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                  <li class="nav-item">
                                        <a class="nav-link " href="AddAppraisalforDriver.aspx">
                                          Add Appraisal for Driver
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="ViewAppraisalforDriver.aspx">
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Safety</th>
                                                            <th>BOL</th>
                                                            <th>Maintenance of vehicle </th>
                                                            <th>Present</th>
                                                            <th>Punctual</th>
                                                            <th>Uniform related remarks</th>
                                                            <th>Character</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>Dummy Text</td>
                                                            <td class="noprint">
                                                            <a href="AddAppraisalforDriver.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
