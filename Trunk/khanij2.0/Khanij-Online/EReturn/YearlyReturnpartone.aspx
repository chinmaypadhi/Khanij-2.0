<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnpartone.aspx.cs" Inherits="EReturn_YearlyReturnpartone" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnpartone.aspx">
                                         Part 1
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                    ...
                                    <h5 class="text-brown font-weight-bold">Details of  mine</h5>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                               <label class="col-form-label font-weight-bolder">Registration No. (allotted by IBM)</label>
                                                <input type="text" class="form-control">
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                 <label  class="col-form-label font-weight-bolder">Mine Code (allotted by IBM)</label>
                                                  <input type="text" class="form-control">
                                            </div>
                                             <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnpartone', 'glereturn', 'plyearet', 'tl', 'E-Return Non-coal', 'Yearly Return Iron Ore', ' ');
        });
    </script>
