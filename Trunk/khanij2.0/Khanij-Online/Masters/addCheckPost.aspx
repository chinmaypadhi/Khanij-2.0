<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addCheckPost.aspx.cs" Inherits="Masters_addCheckPost" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewCheckPost.aspx">
                                View
                            </a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control">
                                                <option>Select User master</option>
                                            </select>
                                        </div>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Check Post', 'glTMng', 'plmineral', 'tl', 'Masters', 'Check Post', '');
