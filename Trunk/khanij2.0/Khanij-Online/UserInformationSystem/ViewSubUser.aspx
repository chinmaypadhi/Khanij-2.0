<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSubUser.aspx.cs" Inherits="UserInformationSystem_ViewSubUser" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link" href="AddSubUser.aspx">
                                            Add New Sub User
                                        </a>
                                    </li>
                                    <li class="nav-item">
...
<script src="../js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewSubUser', 'glUIS', 'plsubuser', 'tl', 'User Information System', 'Sub User', ' ');
