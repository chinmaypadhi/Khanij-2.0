...
namespace IntegrationApp.ActionFilter
{
    public class SessionActionFilter : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            //Check if the attribute exists on the action method
            if (controllerActionDescriptor.MethodInfo?.GetCustomAttributes(inherit: true)?.Any(a => a.GetType().Equals(typeof(SkipSessionAttribute))) ?? false)
            {
    ...
    public class SkipSessionAttribute : Attribute { }
