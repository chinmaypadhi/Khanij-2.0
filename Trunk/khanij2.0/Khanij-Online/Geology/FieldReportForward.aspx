<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FieldReportForward.aspx.cs" Inherits="Geology_FieldReportForward" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="FieldReportForward.aspx">
                                           Add Field Report Forward
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="ViewFieldReportForward.aspx">
                                           View Field Report Forward
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <section class="box form-container">
                                <div class="content-body">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Select Report Type</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control form-control-sm searchableselect">
                                                          <option>select</option>
                                                      </select> 
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Select Status</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control form-control-sm searchableselect">
                                                          <option>select</option>
                                                      </select> 
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Regional Office</label>
                                                <div class="col-sm-7">
                                                    <select class="form-control form-control-sm searchableselect">
                                                          <option>select</option>
                                                      </select> 
                                         ...
                                         <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Field Report</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Maps & Plates</label>
                                                <div class="col-sm-7">
                                                   <div class="custom-file">
                                         ...
                                         <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label font-weight-bolder">Annexure</label>
                                                <div class="col-sm-7">
                                                    <div class="custom-file">
                                            ...
                                            <div class="col-sm-6  offset-lg-2 offset-md-4">
                                                <a href="ViewFieldReportForward.aspx" class="btn btn-primary btn-md ml-0">Submit</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('FieldReportForward', 'glgeology', 'plrepfor', 'tl', 'Geology', 'Field Report Forward', ' ');
