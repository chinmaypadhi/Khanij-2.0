<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequrest.aspx.cs" Inherits="EndUserProfileRequest_NewRequrest" %>
                            ...
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item mr-md-1">
                                        <a class="nav-link active" href="NewRequrest.aspx">
                                            Add New Request
                                        </a>
                                    </li>
                                    <li class="nav-item mr-md-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ActionTaken.aspx">
                                           Action Taken
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="table-responsive" id="viewtable">
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            <td>1</td>
                                                            <td>EUP20201205001</td>
                                                            <td>MOHAN LAL</td>
                                                            <td>
																Mohan lal 
                                                                S/o Doman lal 
                                                                144, A-Block, Indira Marg Sonari
                                                                Lahari Akhara Jamshedpur  
                                                                East Singhbhum -831011 (JH) - [Trader Outside Chhattisgarh]
															</td>
                                                            <td>                                                                
                                                               East Singhbum																
                                                            </td>
                                                            ...
                                                            <td class="noprint">
                                                                <a href="NewRequrestView.aspx" class="btn-floating btn-outline-primary btn-sm"
                                                                        title="Edit">Take Action</a>  
                                                            </td>
                                                        </tr>
