<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YearlyReturnpartthree.aspx.cs" Inherits="EReturn_YearlyReturnpartthree" %>
...
<uc1:navbar runat="server" ID="navbar" />
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                 <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="YearlyReturnpartthree.aspx">
                                         Part 3
                                        </a>
                                    </li>
                                    <li class="nav-item">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('YearlyReturnpartthree', 'glereturn', 'plyearet', 'tl', 'E-Return Non-coal', 'Yearly Return Iron Ore', ' ');
        });
    </script>
