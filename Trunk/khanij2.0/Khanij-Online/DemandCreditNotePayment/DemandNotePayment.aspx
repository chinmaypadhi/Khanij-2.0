<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DemandNotePayment.aspx.cs"
    Inherits="DemandCreditNotePayment_DemandNotePayment" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="DemandNotePayment.aspx" >
                                DemandNotePaymentSummary
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="CreditNotePayment.aspx">
