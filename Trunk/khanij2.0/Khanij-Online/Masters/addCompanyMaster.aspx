<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addCompanyMaster.aspx.cs" Inherits="Masters_addCompanyMaster" %>
            ...
            <div class="col-12">
                <div class="main-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewCompanyMaster.aspx"  >
                                View
                            </a>
                        </li>
                    </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('Add Company Master', 'glTMng', 'plmineral', 'tl', 'Masters', 'Company Master', '');
