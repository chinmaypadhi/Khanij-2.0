<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewDepartment.aspx.cs" Inherits="Masters_NewDepartment" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewNewDepartment.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('NewDepartment', 'glTMng', 'pldepartment', 'tl', 'Master', 'Department', '');
