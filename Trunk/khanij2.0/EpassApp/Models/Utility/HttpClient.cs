   ...
   public  class HttpWebClients : IHttpWebClients
    {
        ...
        public string PostRequest(string URI, string parameterValues)
        {
            ...
            string BaseURI = _objKeyList.Value.WebApiurl;// "http://localhost:54353/api/";//  System.Configuration.ConfigurationManager.AppSettings["WebAPIURI"].ToString();
        ...
        private string GetJwt()
        {
            ...
            string BaseURI = "http://localhost/ApiGateway/api/";
