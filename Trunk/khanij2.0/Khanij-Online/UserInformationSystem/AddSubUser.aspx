<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSubUser.aspx.cs" Inherits="UserInformationSystem_AddSubUser" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ViewSubUser.aspx">
                                            View
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <section class="box form-container">
                                <div class="content-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-4 col-form-label">Applicant Name<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dropdownUserType" class="col-sm-4 col-form-label">Password <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="dropdownDepart" class="col-sm-4 col-form-label">Mobile <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                <label for="inputPassword" class="col-sm-4 col-form-label">Email <span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
...
<!-- alert 1-->
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('AddSubUser', 'glUIS', 'plsubuser', 'tl', 'User Information System', 'Sub User', ' ');
