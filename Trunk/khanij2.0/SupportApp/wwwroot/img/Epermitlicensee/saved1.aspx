<%@ Page Language="C#" AutoEventWireup="true" CodeFile="saved1.aspx.cs" Inherits="Epermitlicensee_saved" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link " href="newapplication.aspx">
                                            New e-permit
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="saved1.aspx">
                                            Saved Application
                                        </a>
                                   </li>
                            ...
                            <section class="box form-container">
                                    ...
                                    <div class="searchform">
                                       <div class="row">
                                                    <label  class="col-lg-2 col-md-5 col-sm-12 col-form-label form-group">Application Id</label>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr >
                                                            ...
                                                            <td>Coal</td>
                                                            <td>OM -G1 (Above 4001 to 4300 GCV/Killo Calories)</td>
                                                            <td class="text-right">10</td>
                                                            <td>04-12-2020</td>
                                                            <td class="text-center">
                                                            <a href="savgenerate.aspx" class="btn-floating btn-outline-primary btn-sm">Generate</a>
                                                            </td>
                                                        </tr>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            loadNavigation('saved1', 'glepermitlicensee', 'apply', 'tl', 'e-permit', 'Apply e-permit', ' ');
