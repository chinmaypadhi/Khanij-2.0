<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSendNoticeLetter.aspx.cs" Inherits="NoticeLetter_ViewSendNoticeLetter" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="ViewSendNoticeLetter.aspx">
                                          View
                                        </a>
                                    </li>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewSendNoticeLetter', 'glnoticeletter', 'plviewnotlet', 'tl', 'Notice Letter', 'Reply Notice Letter', ' ');
