...
namespace HelpdeskApp.Areas.Helpdesk.Models.Ticket
{
    public interface ITicketModel
    {
        ...
        /// <returns></returns>
        MessageEF Add(RaiseTicket objPaymentTypeMaster);
        /// <summary>
        /// Added by suroj on 3-mar-2021 to fetch userdetails 
        /// </summary>
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        RaiseTicket FetchDetails(RaiseTicket objRaiseTicket);
        /// <summary>
        /// Added by suroj on 18-mar-2021 to Bind state
        /// </summary>
        /// <param name="objRaiseTicket"></param>
        /// <returns></returns>
        List<RaiseTicket> BindState(RaiseTicket objRaiseTicket);
        /// <summary>
        /// Added by suroj on 13-mar-2021 to Bind userlist aginast district
        /// </summary>
        /// <param name="objRaiseTicket"></param>
        /// <returns></returns>
        List<RaiseTicket> DBind(RaiseTicket objRaiseTicket);
        /// <summary>
        ...
        List<RaiseTicket> FetchComplain(RaiseTicket objRaiseTicket);
        /// <summary>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        List<RaiseTicket> GetDistrictDataForUser(RaiseTicket objRaiseTicket);
        /// <summary>
        /// Added by suroj on 7-apr-2021 to bind FMS Userlist
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        List<RaiseTicket> GetFMSUsersList(RaiseTicket objRaiseTicket);
        /// <summary>
        /// Added by suroj on 11-apr-2021 to update the ticketby Authority user
        /// </summary>
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        int Update(RaiseTicket objPaymentTypeMaster);
        /// <summary>
        /// Added by suroj on 13-apr-2021 to close ticket
        /// </summary>
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        MessageEF CloseTicket(RaiseTicket objPaymentTypeMaster);
        ...
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        int TakeAction(BackendModel objPaymentTypeMaster);
        /// <summary>
        /// Added by suroj on 1-apr-2021 to pull ticket
        /// </summary>
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        int PullTicket(RaiseTicket objPaymentTypeMaster);
        /// <summary>
        ...
        int Queryinsert(BackendModel objPaymentTypeMaster);
        /// <summary>
        /// Added by suroj on 6-apr-2021 to Insert/Update Query Backend Query
        /// </summary>
        /// <param name="objPaymentTypemaster"></param>
        /// <returns></returns>
        int InsertExecution(BackendModel objPaymentTypeMaster);
        /// <summary>
        /// Added by suroj on 9-apr-2021 to fetch userdetails aginast usercode
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        List<RaiseTicket> GetUserDetailsByUserCode(RaiseTicket objRaiseTicket);
        /// <summary>
        ...
        /// <param name="objraiseticket"></param>
        /// <returns></returns>
        int DgmApproval(BackendModel objPaymentTypeMaster);
        /// <summary>
        /// //Added by suroj on 10-aug-2021 to get compainer details against ticketid
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        RaiseTicket Fetchuserdetailshistory(RaiseTicket objPaymentTypeMaster);
