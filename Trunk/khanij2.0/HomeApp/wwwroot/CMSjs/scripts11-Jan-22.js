...
/*$('.module-icon.open-module').hide();
$('.module-icon.close-module').on('click', function () {
    $('.module-icon.open-module').show();
    $('.module-icon.close-module').hide();
})
$('.module-icon.open-module').on('click', function () {
    $('.module-icon.close-module').show();
    $('.module-icon.open-module').hide();
})
