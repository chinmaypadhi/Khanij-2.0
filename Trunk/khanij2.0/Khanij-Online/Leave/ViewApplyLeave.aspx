<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewApplyLeave.aspx.cs" Inherits="Leave_ViewApplyLeave" %>
                        ...
                        <div class="col-12">
                            <div class="main-tab">
                                <ul class="nav nav-tabs">
                                 <li class="nav-item">
                                        <a class="nav-link " href="AddApplyLeave.aspx">
                                           Add Apply leave
                                        </a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link active" href="ViewApplyLeave.aspx">
                                           View Apply Leave
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <table id="datatable" class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr class="active-row">
                                                            ...
                                                            <td>Dummy Text</td>
                                                            <td class="noprint">
                                                            <a href="AddApplyLeave.aspx" class="btn-floating btn-outline-primary btn-sm waves-effect waves-light" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></a>
...
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet">
    ...
    <script>
        ...
        $(document).ready(function () {
            loadNavigation('ViewApplyLeave', 'glholiday', 'plappleav', 'tl', 'Leave', 'Apply Leave', ' ');
